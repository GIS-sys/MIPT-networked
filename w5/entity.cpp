...
{
    Entity e = e1;
    e.x = (e1.x * dt2 + e2.x * dt1) / (dt1 + dt2);
    e.y = (e1.y * dt2 + e2.y * dt1) / (dt1 + dt2);
    e.vx = (e1.vx * dt2 + e2.vx * dt1) / (dt1 + dt2);
    e.vy = (e1.vy * dt2 + e2.vy * dt1) / (dt1 + dt2);
    e.ori = (e1.ori * dt2 + e2.ori * dt1) / (dt1 + dt2);
    e.omega = (e1.omega * dt2 + e2.omega * dt1) / (dt1 + dt2);
    return e;
}
